    ...
    <div className="max-w-2xl">
      ...
      <motion.div initial="hidden" animate="visible" variants={stagger}>
        ...
        <motion.div variants={fadeInUp} className="backdrop-blur-[2px] bg-white/10 p-4 rounded-[32px] -ml-4">
          ...
          <div className="space-y-6 text-small-heading text-brand-ink font-semibold leading-relaxed mb-12 drop-shadow-sm">
            <p>
    ...
    <div className="grid md:grid-cols-3 gap-10">
      {[
        ...
        >
          ...
          <h3 className="relative z-10 text-section font-kids font-bold mb-6 text-brand-ink group-hover:text-white transition-colors duration-500">{item.title}</h3>
      ...
      <section className="relative py-40 px-6 bg-white overflow-hidden">
        <div className="max-w-5xl mx-auto text-center">
           ...
           >
              ...
              <h3 className="text-section font-kids font-bold text-brand-ink mb-8">Positive Reinforcement.</h3>
  ...
  <div className="max-w-7xl mx-auto px-12 grid lg:grid-cols-12 gap-16 items-center relative z-10">
    ...
    <div className="lg:col-span-6 relative">
      ...
      <section className="py-40 max-w-5xl mx-auto px-6">
        <h2 className="text-section font-kids font-bold text-brand-ink mb-20 text-center">Your Questions, <span className="text-brand-teal">Answered.</span></h2>
        <div className="space-y-6">
      ...
      <section className="py-24 px-6 lg:px-12 max-w-7xl mx-auto text-center">
        <div className="bg-brand-teal rounded-[80px] p-20 lg:p-32 text-white relative overflow-hidden shadow-3xl">
          ...
          <h2 className="text-display font-kids font-bold mb-10 relative z-10 leading-tight">Start the Journey.</h2>
          <p className="text-small-heading opacity-90 mb-16 max-w-3xl mx-auto relative z-10 font-medium">
