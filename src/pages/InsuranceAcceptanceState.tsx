...
const insuranceData: Record<string, any[]> = {
  "Texas": [
    { name: "Blue Cross Blue Shield of Texas (BCBS TX)", logo: "BCBS" },
    { name: "Aetna Commercial", logo: "Aetna" },
    { name: "Cigna", logo: "Cigna" },
    { name: "United Healthcare", logo: "UHC" },
    { name: "Wellpoint Medicaid", logo: "WP" },
    { name: "Aetna Medicaid", logo: "Aetna" },
    { name: "Superior Health", logo: "SH" },
    { name: "Molina", logo: "Molina" },
    { name: "Carelon", logo: "Carelon" },
