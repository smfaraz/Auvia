...
const insuranceData: Record<string, any[]> = {
  "Texas": [
    { name: "90 Degree Benefits", logo: "90" },
    { name: "Blue Cross Blue Shield of Texas Inc.", logo: "BCBS" },
    { name: "UnitedHealthcare", logo: "UHC" },
    { name: "Cigna", logo: "C" },
    { name: "Ambetter TX", logo: "Amb" },
    { name: "Aetna", logo: "A" },
    { name: "UMR", logo: "UMR" },
    { name: "Optum", logo: "Opt" },
    { name: "Ascension", logo: "Asc" },
    { name: "Aspirant", logo: "Asp" },
    { name: "Automated Benefit Services (ABS)", logo: "ABS" },
    { name: "All Savers", logo: "AS" },
    { name: "Allied Benefit Systems Inc.", logo: "Allied" },
    { name: "PHCS", logo: "PHCS" }
  ],
  "Arizona": [
    { name: "Anthem BCBS", logo: "Anthem" },
    { name: "Blue Cross Blue Shield (national)", logo: "BCBS" },
    { name: "Aetna", logo: "A" },
    { name: "Cigna", logo: "C" },
    { name: "Bind Benefits Inc.", logo: "Bind" },
    { name: "Carefirst Administrators", logo: "CF" },
    { name: "Carelon (Out-of-Network)", logo: "Carelon" }
  ],
  "Colorado": [
    { name: "AdventHealth Medical Group", logo: "AH" },
    { name: "UnitedHealthcare", logo: "UHC" },
    { name: "Allegiance", logo: "Allg" },
    { name: "Beacon Health Options", logo: "BHO" },
    { name: "Medica", logo: "Med" }
  ]
};
          ...
          <AnimatePresence mode="popLayout">
            {filteredProviders.map((provider) => (
              ...
              >
                ...
                <div className="w-16 h-16 bg-[#F0FDF4] rounded-2xl flex items-center justify-center shrink-0 border border-brand-mint/30 group-hover:bg-brand-mint/20 transition-colors">
                  <span className="text-xl font-bold text-brand-teal">{provider.logo}</span>
                </div>
