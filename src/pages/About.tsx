      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-40 relative z-10">
          {[
            ...
            <div key={i} className="glass-panel card-friendly group relative overflow-hidden">
              ...
              <p className="text-brand-sage leading-relaxed font-medium relative z-10">{value.text}</p>
            </div>
          ))}
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-20 items-center mb-32 relative z-10">
          <div className="lg:w-1/2">
            <h2 className="text-section font-kids font-bold text-brand-ink mb-10 leading-tight">A Happy Place for <br /><span className="italic text-brand-teal">Every Friend.</span></h2>
