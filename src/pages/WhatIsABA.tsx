...
export const WhatIsABA = () => {
  ...
  return (
    <div className="bg-[#F8FBFA] selection:bg-brand-teal/20 text-[#1F2937] font-sans overflow-x-hidden">
      ...
      <section className="relative pt-20 lg:pt-24 pb-20 lg:pb-32 px-6 lg:px-12 bg-gradient-to-b from-[#E0F7FA] via-white to-[#F8FBFA]">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-24 items-center relative z-10 text-center lg:text-left">
          ...
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            <motion.div variants={fadeInUp} className="space-y-6 text-body-main text-brand-sage font-medium leading-relaxed max-w-xl mb-10 lg:mb-12 mx-auto lg:mx-0">
              <p>
                Applied Behavior Analysis (ABA) is the gold-standard, evidence-based scientific discipline focused on understanding and improving meaningful human behaviors.
              </p>
              <p>
                Rooted in over 50 years of clinical research, our play-based ABA programs help children build essential milestones in functional communication, social connection, emotional regulation, and adaptive daily living skills.
              </p>
            </motion.div>

            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row flex-wrap gap-4 lg:gap-5 justify-center lg:justify-start">
          ...
          >
            ...
            >
               <p className="font-kids font-bold text-small-heading text-brand-teal italic leading-tight text-center">
      ...
      {/* 2. THE AUVIA MODEL: The Foundation */}
      <section className="py-20 lg:py-32 px-6 lg:px-12 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 lg:mb-24">
            <h2 className="text-section font-kids font-bold text-brand-ink mb-6 lg:mb-8">How ABA <span className="text-brand-teal italic">Works.</span></h2>
            <p className="text-body-main text-brand-sage max-w-3xl mx-auto font-medium">ABA looks at how the environment affects a person's behavior using the "ABC" model:</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10">
            {[
              ...
              <motion.div key={i} whileHover={{ y: -15 }} className="bg-[#FCFAF7] p-8 lg:p-16 rounded-[40px] lg:rounded-[60px] border border-gray-50 text-center shadow-sm">
                <div className={`w-20 lg:w-28 h-20 lg:h-28 ${item.color} rounded-full flex items-center justify-center mx-auto mb-8 lg:mb-10 border-4 border-white shadow-lg`}>
                   <span className="text-section font-kids font-bold text-brand-teal">{item.letter}</span>
                </div>
                <h3 className="text-small-heading font-kids font-bold mb-4 lg:mb-6">{item.title}</h3>
                <p className="text-base lg:text-xl text-brand-sage font-medium">{item.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 bg-[#FCFAF7] rounded-[100px] mx-6">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <h2 className="text-section font-kids font-bold text-brand-ink mb-8">7 Dimensions <br /><span className="text-brand-teal italic">of ABA.</span></h2>
          ...
          <div className="bg-white p-12 lg:p-20 rounded-[80px] shadow-xl border border-gray-100 mb-16 flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/3">
              ...
              <h3 className="text-section font-kids font-bold mb-6">Generalization</h3>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-20 items-center mb-24">
            <motion.div 
              ...
              className="lg:w-1/2"
            >
              <h2 className="text-display font-kids font-bold text-brand-ink mb-10 leading-tight">
          ...
          >
            {[
              { title: "Communication & Language", icon: <MessageCircle />, items: ["Functional Communication Training (FCT)", "Vocal & AAC device mastery", "Conversational reciprocity"], color: "bg-[#E0F2F1]" },
              { title: "Social Interaction & Play", icon: <Users />, items: ["Peer collaboration & shared joy", "Cooperative & imaginative play", "Social perspective taking"], color: "bg-[#E1F5FE]" },
              { title: "Daily Living & Self-Care", icon: <Baby />, items: ["Potty training & self-care routines", "Feeding & mealtime independence", "Community & school transitions"], color: "bg-[#F3E5F5]" },
              { title: "Emotional Self-Regulation", icon: <Heart />, items: ["Recognizing emotional states", "Sensory calming strategies", "Adaptive coping mechanisms"], color: "bg-[#FFF9C4]" },
              { title: "Cognitive & School Readiness", icon: <BookText />, items: ["Sustained attention & focus", "Classroom routine adaptation", "Executive functioning support"], color: "bg-[#E8F5E9]" },
              { title: "Environmental Safety & Advocacy", icon: <ShieldAlert />, items: ["Community safety awareness", "Self-advocacy & boundary setting", "Replacement behaviors for distress"], color: "bg-[#FFEBEE]" }
            ].map((skill, i) => (
              <motion.div 
      ...
      <section className="py-32 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <motion.h2 
              initial="hidden" whileInView="visible" variants={fadeInUp} viewport={{ once: true }}
              className="text-section font-kids font-bold text-brand-ink mb-8 leading-tight"
            >
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-12">
              <div className="space-y-6">
                <h3 className="text-section font-kids font-bold text-brand-ink">Everyday Milestones.</h3>
      ...
      <section className="py-20 lg:py-32 bg-[#FCFAF7] rounded-[60px] lg:rounded-[100px] mx-4 lg:mx-6">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 lg:mb-24">
            <motion.div 
              initial="hidden" whileInView="visible" variants={fadeInUp} viewport={{ once: true }}
              className="inline-flex items-center gap-2 px-5 py-2 bg-brand-peach/20 text-brand-peach rounded-full text-[10px] lg:text-sm font-bold uppercase tracking-widest mb-6"
            >
               <Sunrise size={16} /> Bridging the Gap
            </motion.div>
            <h2 className="text-section font-kids font-bold text-brand-ink mb-6 lg:mb-8 leading-tight">
              Bright <span className="text-brand-teal italic">Beginnings.</span>
            </h2>
            <p className="text-body-main text-brand-sage max-w-4xl mx-auto font-medium leading-relaxed">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="relative z-10">
                <h3 className="text-section font-kids font-bold mb-8">Early Learning, Early Success.</h3>
      ...
      <section className="py-40 max-w-5xl mx-auto px-6">
        <h2 className="text-section font-kids font-bold text-brand-ink mb-20 text-center">Your Questions.</h2>
        <div className="space-y-6">
          {[
      ...
      <section className="py-16 lg:py-24 px-6 lg:px-12 max-w-7xl mx-auto text-center">
        <div className="bg-brand-teal rounded-[40px] lg:rounded-[80px] p-10 lg:p-32 text-white relative overflow-hidden shadow-3xl">
          <FlaskConical className="absolute top-6 lg:top-10 left-6 lg:left-10 opacity-20 w-16 lg:w-32 h-16 lg:h-32" />
          <h2 className="text-display font-kids font-bold mb-6 lg:mb-10 relative z-10 leading-tight">Join the Family.</h2>
          <p className="text-lg md:text-small-heading opacity-90 mb-10 lg:mb-16 max-w-3xl mx-auto relative z-10 font-medium">
            Join thousands of families who have experienced the Auvia difference in science-backed care.
          </p>
          <Link to="/contact" className="inline-block bg-white text-brand-teal px-10 lg:px-16 py-5 lg:py-7 rounded-[18px] lg:rounded-[24px] font-kids font-bold text-xl lg:text-3xl hover:bg-brand-mint transition-all shadow-xl relative z-10">
            Book a Consultation
          </Link>
        </div>
      </section>
