    ...
    <div className="bg-[#F8FBFA] selection:bg-brand-teal/20 text-[#1F2937] font-sans overflow-x-hidden">
      ...
      <section className="relative pt-32 lg:pt-44 pb-20 lg:pb-32 px-6 lg:px-12 bg-gradient-to-b from-[#E0F7FA] via-white to-[#F8FBFA]">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-24 items-center relative z-10 text-center lg:text-left">
          ...
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            <motion.h1 variants={fadeInUp} className="text-4xl md:text-6xl lg:text-8xl font-kids font-bold text-brand-ink mb-8 lg:mb-10 leading-[0.9] tracking-tight">
              What is <br /><span className="text-brand-teal italic">ABA Therapy?</span>
            </motion.h1>
            
            <motion.div variants={fadeInUp} className="space-y-6 text-lg md:text-xl text-brand-sage font-medium leading-relaxed max-w-xl mb-10 lg:mb-12 mx-auto lg:mx-0">
              <p>
      ...
      <section className="py-20 lg:py-32 px-6 lg:px-12 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 lg:mb-24">
            <h2 className="text-4xl md:text-5xl lg:text-7xl font-kids font-bold text-brand-ink mb-6 lg:mb-8">How ABA <span className="text-brand-teal italic">Works.</span></h2>
            <p className="text-lg md:text-2xl text-brand-sage max-w-3xl mx-auto font-medium">ABA looks at how the environment affects a person's behavior using the "ABC" model:</p>
          </div>
            ...
            {[
              ...
              <motion.div key={i} whileHover={{ y: -15 }} className="bg-[#FCFAF7] p-8 lg:p-16 rounded-[40px] lg:rounded-[60px] border border-gray-50 text-center shadow-sm">
                <div className={`w-20 lg:w-28 h-20 lg:h-28 ${item.color} rounded-full flex items-center justify-center mx-auto mb-8 lg:mb-10 border-4 border-white shadow-lg`}>
                   <span className="text-3xl lg:text-5xl font-kids font-bold text-brand-teal">{item.letter}</span>
                </div>
                <h3 className="text-2xl lg:text-3xl font-kids font-bold mb-4 lg:mb-6">{item.title}</h3>
      ...
      <section className="py-20 lg:py-32 bg-[#FCFAF7] rounded-[60px] lg:rounded-[100px] mx-4 lg:mx-6">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 lg:mb-24">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-7xl font-kids font-bold text-brand-ink mb-6 lg:mb-8 leading-tight">
              Bright <span className="text-brand-teal italic">Beginnings.</span>
            </h2>
            <p className="text-lg md:text-2xl text-brand-sage max-w-4xl mx-auto font-medium leading-relaxed">
      ...
      <section className="py-16 lg:py-24 px-6 lg:px-12 max-w-7xl mx-auto text-center">
        <div className="bg-brand-teal rounded-[40px] lg:rounded-[80px] p-10 lg:p-32 text-white relative overflow-hidden shadow-3xl">
          ...
          <h2 className="text-4xl md:text-6xl lg:text-8xl font-kids font-bold mb-6 lg:mb-10 relative z-10 leading-tight">Join the Family.</h2>
          <p className="text-lg md:text-2xl lg:text-3xl opacity-90 mb-10 lg:mb-16 max-w-3xl mx-auto relative z-10 font-medium">
