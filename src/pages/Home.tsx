...
export const Home = () => {
  ...
  return (
    <div className="bg-[#FCFAF7] selection:bg-brand-teal/20 text-brand-ink font-sans">
      ...
      <section className="relative min-h-[95vh] flex items-center pt-20 bg-gradient-to-br from-brand-sky via-white to-brand-peach/30 overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full pointer-events-none">
          ...
          <motion.div
            ...
            className="absolute top-[10%] right-[5%] w-[600px] h-[600px] bg-brand-teal-light/20 rounded-full blur-[120px]"
          />
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <p className="text-label-custom text-brand-sage mt-1">Sanctuary Network</p>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full grid lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          <motion.div
            ...
            className="glass-panel p-8 lg:p-12 rounded-[40px] premium-shadow border border-white/60 relative"
          >
            {/* Subtle accent line */}
            <div className="absolute top-0 left-12 right-12 h-[2px] bg-gradient-to-r from-transparent via-brand-teal/30 to-transparent" />

            <div className="flex items-center gap-4 mb-6">
              <span className="bg-brand-mint text-brand-teal px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest shadow-sm">Welcome</span>
            </div>
            ...
            <p className="text-body-main text-brand-sage mb-10 lg:mb-12 max-w-xl font-medium leading-relaxed border-l-4 border-brand-teal/20 pl-6 lg:pl-8">
            ...
            <button
              ...
              className="btn-friendly-primary text-lg w-full sm:w-auto"
            > Connect With Us
            </button>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <motion.div
              ...
              className="p-8 rounded-[40px] glass-panel card-friendly relative z-10"
            >
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-brand-teal to-brand-teal-light text-white px-5 py-1.5 rounded-full text-label-custom uppercase tracking-widest shadow-lg">
                Fastest Start
              </div>
              ...
              <button
                ...
                className="bg-brand-teal text-white w-full py-3 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-brand-teal-light transition-colors text-body-normal-normal-sm shadow-md"
              >
      ...
      <section className="py-12 md:py-20 bg-brand-teal text-white rounded-[40px] md:rounded-[100px] mx-4 md:mx-6 mt-0 mb-10 md:mb-16 relative overflow-hidden shadow-2xl">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
          ...
          >
            <span className="inline-block py-2 px-5 rounded-full bg-white/20 text-white font-bold uppercase tracking-widest mb-6 border border-white/30 backdrop-blur-sm text-xs">
              Begin Your Journey
            </span>
          ...
          >
            <motion.div variants={itemVariants} className="bg-white/10 backdrop-blur-xl p-8 md:p-12 rounded-[32px] md:rounded-[50px] border border-white/20 text-left hover:bg-white/20 transition-all duration-300 group cursor-pointer hover:-translate-y-2 premium-shadow">
              ...
              <p className="text-white/90 text-body-normal-normal mb-6 md:mb-10 font-medium">We will help to connect you to resources to get your child evaluated and get a diagnosis report.</p>
              <button
            ...
            <motion.div variants={itemVariants} className="bg-white/20 backdrop-blur-xl p-8 md:p-12 rounded-[32px] md:rounded-[50px] text-left shadow-2xl border border-white/40 group cursor-pointer hover:-translate-y-2 transition-all duration-300 hover:bg-white/30">
              <h3 className="text-small-heading font-kids font-bold mb-4 md:mb-5 text-white drop-shadow-md">My child has an autism diagnosis.</h3>
              <p className="text-white text-body-normal-normal mb-6 md:mb-10 font-medium drop-shadow-sm">Start your journey today. We handle the insurance paperwork so you can focus on your child.</p>
              <button
      ...
      <section className="pt-8 pb-16 md:pt-12 md:pb-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-section font-kids font-bold mb-8 sm:mb-12 tracking-tight">Celebrate Your <span className="text-brand-teal italic underline decoration-brand-peach underline-offset-[12px]">Big Moments.</span></h2>
      ...
      <section
        id="interest-form"
        className="py-12 md:py-20 bg-brand-lavender/30"
      >
        <div className="max-w-7xl mx-auto px-6">
      ...
      {/* Newsletter Section */}
      <section className="py-8 md:pb-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-12">
              <div className="max-w-xl text-center lg:text-left">
                ...
                <p className="text-body-normal-normal-main text-white/70">
                  Join our community of families and receive expert tips, evidence-based developmental strategies, and inspiring family stories delivered straight to your inbox.
                </p>
              </div>
